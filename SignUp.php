...
if(isset($_POST['submit']) && $_POST['submit']=='submit')	{
  	...
  	$query="select username from login_patient where username='$username'";
  ...
  if(count($completeError)>0) {?>
	...
	$dbName="d&d";
	$query="insert into patient_info(name,gender,date_of_birth,phone_number,email,height,weight,password,username,StreetAddress,StreetLine2,City,State,Zip_Code,Country) values ('$name','$gender','$dateOfBirth','$phoneNumber','$email','$height','$weight','$password','$username','$streetAddress','$streetLine2','$city','$state','$zipCode','$country')";
	$result=mysqli_query($conn,$query) or die(mysqli_error());
	$query="insert into login_patient(username,password) values('$username','$password')";
	$result=mysqli_query($conn,$query) or die(mysqli_error());
	$_SESSION['username']=$username;
				...
				<form action="SignUp.php" method="post">
					...
					<li>
						...
						<li> 
							...
							<div class="form-input">
								<input type="text" name="height" id = "height" placeholder="cms" required>
							</div>
						</li>
												<li> 
							<label class="form-label">
							...
							<div class="form-input">
								<input type="text" name="weight" id = "weight" placeholder="pounds" required >
							</div>
						</li>
