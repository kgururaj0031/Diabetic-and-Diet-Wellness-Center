...
if(isset($_POST['submit']) && $_POST['submit']=='submit')	{
	...
	$_SESSION['username']=$_POST['patient_name'];;
	
	header('Location:ehr_page_doctor.php');
}	
?>
...
<head>
	<title>D&D : View Patient's EHR</title>
	<!--/tags -->
...
<div class="banner_inner_content_agile_w3l">
	...
	<div class="heading">
		<h1>View Patient EHR</h1>
	</div>
		<div class="container_1">
			<div class="heading">
				<h2>Please Enter The Patient's Name</h2></br></br>
			</div>
				...
				<form action="patient_ehr.php" method="post">
						<li>
							...
							<div class="form-input">
								<select class="form-dropdown" name="patient_name"  id="patient_name" required>
									<option value="">&nbsp;</option>
									<?php $query="select username from patient_info where doctor='$username'";
