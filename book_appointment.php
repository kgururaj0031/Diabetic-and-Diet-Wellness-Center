...
if(isset($_POST['submit']) && $_POST['submit']=='submit')	{
	...
	$_SESSION['type_of_disease']=$type_of_disease;
...
<div class="banner_inner_content_agile_w3l">
	...
	<div class="heading">
		...
		<div class="container_1">
			<div class="heading">
				<h2>Please Enter The Type of Doctor</h2></br></br>
			</div>
			<div class="agile-form">
				<form action="book_appointment.php" method="post">
						<li>
							<label class="form-label">
							   Type of Doctor for visit
							   <span class="form-required"> * </span>
							</label>
							<div class="form-input">
								<select class="form-dropdown" name="type_of_disease"  id="type_of_disease" required>
									<option value="">&nbsp;</option>
									<option value="nutrition" name="nutrition" id="nutrition"> Nutrition </option>
									<option value="type1" name="type1" id="type1"> Diabetes Type 1 </option>
									<option value="type2" name="type2" id="type2"> Diabetes Type 2 </option>
									<option value="gestational" name="gestational" id="gestational"> Gestational Diabetes </option>
									<option value="pediatrician" name="pediatrician" id="pediatrician"> Pediatrition </option>
									<option value="physician" name="physician" id="physician"> General Physician </option>
								</select>
							</div>
						</li>
