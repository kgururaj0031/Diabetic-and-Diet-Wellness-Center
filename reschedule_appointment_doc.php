...
if(isset($_POST['submit']) && $_POST['submit']=='submit')	{
	...
	$dbName="d&d";
	$sql = "UPDATE apppointment_patient SET date='$date' WHERE doctor='$username' and patient_name='$patient'";
				...
				<form action="reschedule_appointment_doc.php" method="post">
					<ul class="field-list">
						...
						<li>
							...
							<div class="form-input">
								<select class="form-dropdown" name="patient" id="patient" required>
									<option value="">&nbsp;</option>
									<?php
										$username = $_SESSION['doctor'];

										$query="select patient_name from apppointment_patient where doctor='$username'";
